    ...
    return (
        <section className="relative w-full bg-[#FAFBFD] overflow-hidden border-t border-slate-200">
            <div className="flex flex-col lg:flex-row min-h-0 lg:min-h-[700px]">
                ...
                {/* Text - Left */}
                <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 md:p-16 lg:p-24 order-2 lg:order-1">
                    <motion.div
                    ...
                    >
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold text-[#0D2C51] mb-6 md:mb-8 leading-tight">
                        ...
                        <div className="space-y-6 sm:space-y-8 mt-6 sm:mt-10">
                            {[
                                ...
                                <div key={item.t}>
                                    <h4 className="text-base sm:text-lg font-bold text-[#0D2C51] mb-2">{item.t}</h4>
                                    <p className="text-sm sm:text-base text-slate-600 font-medium">{item.d}</p>
                                </div>
                            ))}
                        </div>
                    </motion.div>
