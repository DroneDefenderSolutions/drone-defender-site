    ...
    return (
        <section className="relative w-full bg-white overflow-hidden">
            <div className="flex flex-col lg:flex-row min-h-[700px]">
                {/* Text - Left - Centered */}
                <div className="w-full lg:w-1/2 flex items-center justify-center p-12 lg:p-24 bg-white order-1 lg:order-none">
                    <motion.div
                    ...
                    >
                        ...
                        <h2 className="text-4xl lg:text-5xl font-bold text-[#0D2C51] mb-8 leading-[1.1] tracking-tight">
                        ...
                        <ul className="space-y-4">
                            {['Governance aligned threat assessment', 'Strategic layered defence design', 'Evidence disciplined procedure'].map((item) => (
                                <li key={item} className="flex items-center text-[#0D2C51] font-semibold text-sm tracking-wide">
                ...
                {/* Image - Right - Flush */}
                <div className="w-full lg:w-1/2 relative min-h-[400px] lg:min-h-full order-2 lg:order-none">
                    <Image
